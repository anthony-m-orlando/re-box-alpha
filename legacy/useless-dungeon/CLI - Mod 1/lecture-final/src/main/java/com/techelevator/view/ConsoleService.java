...
import com.techelevator.generators.ProfessionGenerator;
...
public class ConsoleService {
    ...
    public static void printRoomDescription(Room currentRoom){
        System.out.println("Welcome to room number " + currentRoom.getRoomId());
    ...
    public static Profession inputProfessionOptions(){
        ...
        while (!validInput) {
            ...
            for (Profession profession : ProfessionGenerator.getBasicFantasyProfessions()) {
    ...
    public static int inputGameDifficultySelection(List<String> difficultyList) {
        boolean validInput = false;
        Scanner userInput = new Scanner(System.in);
        int selected = 0;
        while (!validInput) {
