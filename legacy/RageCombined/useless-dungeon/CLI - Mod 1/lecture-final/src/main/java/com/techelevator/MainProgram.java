...
import com.techelevator.model.Villager;

//Builder Classes
import com.techelevator.builders.MonsterBuilder;
import com.techelevator.builders.RoomBuilder;
...
public class MainProgram {
	public static void main(String[] args) {
		...
		Map<Integer, Room> rooms = RoomBuilder.getBasicFantasyRoomMap();

		//Collection of Monster Objects (I wouldn't normally use a map for this but I really wanted to review maps)
		Map<Integer, Monster> monsters = MonsterBuilder.getBasicFantasyMonsterMap();
		//Main hero Object
		Hero myHero;
